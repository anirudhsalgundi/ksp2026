...
for name in xrb_names:
    ...
    try:
        ...
        min_time = min(x_swift[0],x_maxi[0],x_g[0],x_r[0])
        max_time = max(x_swift[-1],x_maxi[-1],x_g[-1],x_r[-1])
        ...
        axs[2].plot(x_g, y_g, color = 'green', markersize=5, marker = 'o', linestyle = 'none') 
        axs[2].plot(x_g_fp, y_g_fp, color = 'green', markersize=5, marker = 's', linestyle = 'none')
        axs[2].plot(x_g_nd, y_g_nd, color = 'green', markersize=5, marker = 'v', linestyle = 'none')
        axs[2].set_title('g ZTF')
        axs[2].invert_yaxis()
        axs[3].plot(x_r, y_r, color = 'red', markersize=5, linestyle = 'none')  
        axs[3].plot(x_r_fp, y_r_fp,color = 'red', markersize=5, marker = 's', linestyle = 'none')
        axs[3].plot(x_r_nd, y_r_nd, color = 'red', markersize=5, marker = 'v', linestyle = 'none')
        ...
        plt.savefig(f'./plots_xrb/{name}.svg', format = "svg")
        plt.show()
    except Exception as e:
